 ...
 * @author marie
 */
public class FXMLInicioResponsablePersonalController implements Initializable{
    @FXML
    ...
    @FXML
    private Button btnVerOpinionesC;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        lPersonal.addAll(obtenerPersonal());
        if(lPersonal.size()>0){
        ...
        try {
            for(int i = 0; i < lPersonal.size(); i++){
                ...
                fxmlLoader.setLocation(getClass().getResource("FXMLItemPersonal.fxml"));
                
                AnchorPane acp = fxmlLoader.load();
                
                FXMLItemPersonalController pc = fxmlLoader.getController();
            ...
            java.util.logging.Logger.getLogger(FXMLInicioResponsablePersonalController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
    ...
    private void clicProductos(ActionEvent event) {
        try {
            ...
            Scene scenePrincipal = new Scene(FXMLLoader.load(getClass().getResource("/GUI/FXMLInicioResponsableProd.fxml")));
    ...
    private void clicCerrarSesion(ActionEvent event) {
        try {
            Stage stage = (Stage) btnCerrarSesion.getScene().getWindow();
            Scene scenePrincipal = new Scene(FXMLLoader.load(getClass().getResource("/GUI/FXMLInicioSesion.fxml")));
            stage.setScene(scenePrincipal);
            stage.setTitle("Inicio");
            stage.show();
        } catch (IOException ex) {
    ...
    @FXML
    private void clicVerOpinionesC(ActionEvent event) {
    }
